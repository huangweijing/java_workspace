 ...
 * LineSegment 是一个不变的抽象数据类型，描述二维空间里的一条线
 **/
public final class LineSegment implements Serializable {
   ...
   * 作用：在两点<code>p1</code> and <code>p2</code>间 构造一条新的线段
   */
   ...
   * <code>l2d</code>
   * 作用： 用相同的coordinates 构造一条新的线段作为<code>l2d</code>
   */
   ...
   * 构造一条新的线段，从&lt;<code>x1</code>,
   * <code>y1</code>&gt; 到 &lt;<code>x2</code>, <code>y2</code>&gt;.
   */
